...
import ies.vamsbackend.services.EruptionService;
...
public class EruptionController {

    private final EruptionService eruptionService;
    private final VolcanoValidationService volcanoValidationService;

    @GetMapping("/{volcano_id}/eruption")
    public ResponseEntity<?> getEruption(
        ...
        try {
            ...
            EruptionDto response = eruptionService.getEruption(volcanoId, dates);
